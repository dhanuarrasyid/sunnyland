...
public class Demo : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha3) && !aniGameOver)
        {
            ...
            Play(gameOverSounds[gameOverSoundIndex]);
            gameOverSoundIndex++;
        ...
        if (Input.GetKeyDown(KeyCode.Alpha2) && !aniPowerUp)
        {
            ...
            Play(powerUpSounds[powerUpSoundIndex]);
            powerUpSoundIndex++;
        ...
        if (Input.GetKeyDown(KeyCode.Alpha5) && !aniCoin)
        {
            ...
            Play(coinSounds[coinSoundIndex]);
            coinSoundIndex++;
        ...
        if (Input.GetKeyDown(KeyCode.Alpha6) && !aniExplosion)
        {
            ...
            Play(explosionSounds[explosionSoundIndex]);
            explosionSoundIndex++;
        ...
        if (Input.GetKey(KeyCode.Alpha1) && player.transform.position.y == 0)
        {
            ...
            Play(jumpSounds[jumpSoundIndex]);
        ...
        if (Input.GetKeyDown(KeyCode.Alpha4))
        {
            ...
            Play(laserSounds[laserSoundIndex]);
